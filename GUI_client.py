            ...
            if Ben is True:
                ...
                if "/new_client_list " in msg:
                    ...
                    def yes_call():
                        ...
                        Label(window_of_call_aud, image=image_photo_call, bg="#212121",
                              activebackground="#212121").place(x=250, y=100)

                        person_call = Canvas(window_of_call_aud, bg="#2F2F38", width=596, height=40, borderwidth=0,
                                             bd=0,
                                             highlightbackground="#3A3A3A")
                        person_call.place(x=0, y=200)
                        person_call.create_text(298, 20, text="Egor", fill="#9E9E9E", font=("NTR", 24 * -1))
...
def new_dialog(event):
    ...
    if group_mode is False and person_list.get(person_list.curselection()[0]) not in groups and person_list.get(
        ...
        Button(main_win, image=image_audio, command=start_audio,
               relief='flat', bg="#212121", activebackground="#212121").place(x=904, y=0)

        Button(main_win, image=image_video, command=lambda: print(),
...
image_user = IT.PhotoImage(file="work_files/def_user.png")
image_audio = IT.PhotoImage(file="work_files/audio.png")
image_video = IT.PhotoImage(file="work_files/video.png")
